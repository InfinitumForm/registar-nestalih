...
<div class="row missing-persons-row pt-3 pb-3" id="missing-persons-main-container">
	...
	<div class="col col-12 col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 missing-item missing-item-<?php echo absint($i); ?> missing-item-id-<?php echo absint($missing->id); ?>" id="missing-item-<?php echo sanitize_title($missing->ime_prezime); ?>">
		...
		<?php if(!empty($missing->icon)) : ?>
			<a class="missing-item-image card-img-top" href="<?php echo $missing->profile_url(); ?>" title="<?php echo esc_attr(esc_html($missing->ime_prezime)); ?>">
				<img src="<?php echo esc_url($missing->icon); ?>" alt="<?php echo esc_attr(esc_html($missing->ime_prezime)); ?>">
			</a>
		<?php endif; ?>
			<div class="card-body">
				<h3 class="card-title missing-item-title">
					<a href="<?php echo $missing->profile_url(); ?>"><?php echo esc_html($missing->ime_prezime); ?></a>
				</h3>
				...
				<a class="btn btn-primary" href="<?php echo $missing->profile_url(); ?>" title="<?php echo esc_attr(esc_html($missing->ime_prezime)); ?>">
